...
export default function AuctionPage() {
  ...
  // 관리자 계정인지 확인하는 함수
  const isadmin = () => {
    return JSON.parse(localStorage.userdata) && JSON.parse(localStorage.userdata).username === "admin" ? true : false;
  };
          ...
          <div style={{ display: "flex", alignItems: "flex-end" }}>
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flex: "1", }}>
              <div id="auctionButton" style={{ width: "400px", height: "100px", margin: "10px", backgroundColor: "#967E76", borderRadius: "50px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                <div onClick={() => { isadmin() ? bidcomplete() : setInputOpen(!inputopen); }}>{isadmin() ? <img src="../../asset/bidok.png"></img> : <img src="../../asset/tab_chat.png"></img>}</div>
