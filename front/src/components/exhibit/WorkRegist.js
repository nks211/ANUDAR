  ...
  return (
    <div className="workRegist">
      <div className="workRegistHeader">
        ...
        <button onClick={() => {
          window.scrollTo({ top: selectxy.current.offsetTop, behavior: "smooth" });
        }}>대표작품 선택
        </button>
      </div>
          ...
          <form>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <button id="workRegistBtn" type="submit" onClick={(event) => {
                ...
                // const newWork = {"id":workId, "title":title, "image":workImg, "detail":detail, "price":price*10000, "is_carousel":false}
                const newWork = { "id": workId, "is_carousel": false, "title": title, "image": workImg, "detail": detail, "price": price * 10000 }

                // const newWork = {"title":title, "image":workImg, "detail":detail, "price":price*10000, "is_carousel":false}
      ...
      <div className="workRegistHeader">
        ...
        <button onClick={() => {
          window.scrollTo({ top: registxy.current.offsetTop, behavior: "smooth" });
        }}>작품 추가하기
        </button>
      </div>
